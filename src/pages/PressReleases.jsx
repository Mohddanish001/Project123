      ...
      <div className="max-w-7xl mx-auto rounded-md px-24 py-10">
        <div className="flex flex-col md:flex-row items-center gap-8 mb-10">
          <div className="flex-1">
            ...
            Writing press releases to announce news, product launches, events, or company updates.
            </p>
          </div>
        </div>
        ...
        <div className="mb-10 px-10">
          <div className="mb-6">
            ...
            <p>
            Preparing proper press releases to distribute significant organizational changes to the stakeholders. 
          ...
          <div className="mb-6">
            ...
            <p>
              {" "}
              Crafting gripping press releases to bring about most events and their attendance.
              {" "}
            </p>
          </div>
          <div className="mb-6">
            ...
            <p>
            Making epic announcements that create FOMO and accelerate the rollout of the new products.
