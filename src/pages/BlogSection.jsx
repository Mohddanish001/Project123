...
<div className="px-4 sm:px-8 lg:px-36 mb-5">
  ...
  <h3 className="text-md sm:text-lg lg:text-xl font-bold text-[#0e6938] mb-2">
  ...
  <ul className="list-disc pl-6 mb-4 text-xs sm:text-sm lg:text-base">
  ...
  <h3 className="text-md sm:text-lg lg:text-xl font-bold text-[#0e6938] mb-2">Content Audit</h3>
  <p className="text-gray-700 text-xs sm:text-sm lg:text-base leading-relaxed mb-4">
  ...
  <h3 className="text-md sm:text-lg lg:text-xl font-bold text-[#0e6938] mb-2">Adapt and Evolve</h3>
  <p className="text-gray-700 text-xs sm:text-sm lg:text-base leading-relaxed mb-4">
  ...
  <h3 className="text-md sm:text-lg lg:text-xl font-bold text-[#0e6938] mb-2">Conclusion</h3>
